  ...
  <div class="rightlistBox">
    <section>
      ...
      <div class="r1-body">
        ...
        <div class="catch-me">
          <div class="">
            <el-tooltip class="item" content="官网" placement="top">
              <a :href="catchMeObj.guanwang" target="_blank"><i><span class="iconfont icon-guanfangwangzhan"></span></i></a>
            </el-tooltip>
            <el-tooltip class="item" effect="dark" content="官微" placement="top">
              <a :href="catchMeObj.wechat" target="_blank"><i><span class="iconfont icon-weixin"></span></i></a>
            </el-tooltip>
            <el-tooltip class="item" effect="dark" content="抖音" placement="top">
              <a :href="catchMeObj.douyin" target="_blank"><i><span class="iconfont icon-douyin"></span></i></a>
            </el-tooltip>
          </div>
          <div class="">
            <el-tooltip class="item" effect="dark" content="B站" placement="top">
              <a :href="catchMeObj.bilibili" target="_blank"><i><span class="iconfont icon-bilibili"></span></i></a>
            </el-tooltip>
            <el-tooltip class="item" effect="dark" content="微博" placement="top">
              <a :href="catchMeObj.weibo" target="_blank"><i><span class="iconfont icon-weibo"></span></i></a>
            </el-tooltip>
          </div>
        </div>
      </div>
...
export default {
  data() {
    ...
    return {
      ...
      catchMeObj: {
        //网址
        guanwang: "https://gcxy.hbut.edu.cn/",
        wechat: "https://gcxy.hbut.edu.cn/dfiles/12846/images/qrcode01.jpg",
        bilibili: "https://space.bilibili.com/357442944?spm_id_from=333.337.0.0",
        douyin: "https://www.douyin.com/user/MS4wLjABAAAA-ih30hTuNB4ydsjqLTTOEFACmEEiRLPG-qmlOUj_UAA?vid=7340840055595945225",
        weibo: "https://weibo.com/2166367893?zw=edu",
      },
    };
  },
  methods: {
